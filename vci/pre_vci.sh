...
python pre_vci.py -s /data/student_kaempchen/ed3dgs-data/vci/2024_12_12_dynamic3 -c /data/student_kaempchen/ed3dgs-data/vci/2024_12_12_dynamic3/poses_2.json --remove_background --use_mapper